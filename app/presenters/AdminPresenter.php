	...
	public function presentTasks() {
		...
		if ($user->isAuthenticated()) {
            ...
            $sql = "
                ...
                ORDER BY name
            ";
            $selectTeamForm->addSelect("team", "Název týmu: ", dibi::query($sql)->fetchPairs("id","name"));
			...
			$rows = dibi::query("SELECT * FROM ".Intersob::DATABASE_PREFIX.Intersob::DATABASE_VIEW_SOLUTIONS." LIMIT 0,30");
